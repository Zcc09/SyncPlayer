...
def main():
    ...
    check("install: app version is 1.6.0",
          get_exe_version(app) == "1.6.3", str(get_exe_version(app)))
    ...
    if os.path.isfile(ij):
        try:
            ...
            pass
    check("install: install.json app_version", state.get("app_version") == "1.6.3")
    ...
    if os.path.isfile(env_json):
        try:
            ...
            env_app = {}
    check("install: packaged app reports its version", env_app.get("version") == "1.6.3",
          str(env_app)[:110])
    ...
    if regvals:
        ...
        check("wizard: Add/Remove entry carries the version",
              str(regvals.get("DisplayVersion", "")) == "1.6.3",
