// Generated by cpp/tools/embed_assets.py - do not edit by hand.
//
...
extern const char* const kLuaBeaconSource = R"kLuaBeaconSource(-- frame-accurate position beacon: mpv 0.41's ${time-pos} in the status
...
end))kLuaBeaconSource";


extern const char* const kInputConfSource = R"kInputConfSource(# Generated by SyncPlayer. The Lua beacon implements syncplayer-click and
...
MBTN_LEFT_DBL script-binding syncplayer-dbl)kInputConfSource";
